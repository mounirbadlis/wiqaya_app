                ...
                builder: (context, controller, _) {
                  if (controller.isLoading) {
                    ...
                    return Column(
                      ...
                      children: [
                        TextButton(onPressed: () {controller.markAllAsSeen();}, child: Text(AppLocalizations.of(context)!.mark_all_as_read,style: Theme.of(context).textTheme.bodyMedium!.copyWith(color: Theme.of(context).secondaryHeaderColor),)),
                        Expanded(
